...
class FlyweightPatternEx {
	public static void main(String[] args) throws Exception {
		...
		shape.Print();
		/*
		 * Here we are trying to get the objects additional 2 times. Note that from now onward we do not need to create additional small robots as we
		 * have already created this category
		 */
		for (int i = 0; i < 2; i++) {
		...
		/*
		 * Here we are trying to get the objects 5 times. Note that the second time onward we do not need to create additional large robots as we have
